...
export function MyShelf() {
  ...
  const actionBtnClass =
    "w-full rounded-full py-3 text-base font-medium transition-all duration-150 hover:opacity-80 active:scale-[0.98]";
      ...
      <aside className="mx-auto flex h-max w-full max-w-xs flex-col items-center gap-8 p-4 lg:col-span-1 lg:sticky lg:top-24">
        {isLoading ? (
          ...
          <>
            ...
            {/* Reading goal */}
            <div className="glass w-full rounded-2xl p-5 flex flex-col gap-3.5 shadow-md">
            ...
            <div className="flex w-full flex-col gap-2.5">
              ...
              <button
                ...
                className={`${actionBtnClass} text-red-600 dark:text-red-400 bg-red-500/10 hover:bg-red-500/15`}
              >
                Logout
              </button>
            </div>
