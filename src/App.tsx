  ...
  return (
    <BrowserRouter>
      <div className="app-bg flex min-h-screen flex-col" style={{ color: "var(--color-ink)" }}>
        ...
        <div className="relative z-0 mx-auto flex w-full max-w-300 flex-1 flex-col px-2 sm:px-3 pt-26 sm:pt-32">
          <Header />
        ...
        {isAuthModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-md bg-black/40 dark:bg-black/60">
